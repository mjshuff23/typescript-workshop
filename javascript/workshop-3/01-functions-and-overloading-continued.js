...
exports.getDataAlternate = exports.getData = void 0;
/*********************************** BAD ***********************************/
...
async function getDataAlternate(url) {
    const resp = await fetch(url);
    if (resp.ok) {
        const data = (await resp.json());
        return data;
...
exports.getDataAlternate = getDataAlternate;
...
async function getDataFinal(url) {
    const resp = await fetch(url);
    if (resp.ok) {
        const data = (await resp.json());
        return data;
